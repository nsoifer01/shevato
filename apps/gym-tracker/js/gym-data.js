  ...
  getDefaultTemplates() {
    return {
      'push_day': {
        ...
        exercises: ['bench_press', 'overhead_press', 'dip', 'tricep_extension']
      },
      'pull_day': {
        id: 'pull_day',
        name: 'Pull Day',
        description: 'Back, Biceps',
        exercises: ['deadlift', 'barbell_row', 'pull_up', 'bicep_curl']
      },
      'leg_day': {
        id: 'leg_day',
        name: 'Leg Day',
        description: 'Quads, Hamstrings, Glutes, Calves',
        exercises: ['squat', 'leg_press', 'calf_raise']
      },
      'full_body': {
        id: 'full_body',
        name: 'Full Body',
        description: 'Complete workout',
        exercises: ['squat', 'bench_press', 'barbell_row', 'overhead_press', 'plank']
      }
    };
  }
