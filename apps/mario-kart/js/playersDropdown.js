...
export function initPlayersDropdown() {
...
function closeOtherDropdowns() {
  ...
  if (addRaceDropdown && addRaceDropdown.classList.contains('open')) {
    if (typeof window.closeAddRaceDropdown === 'function') {
      window.closeAddRaceDropdown();
    }
  }
}
...
window.updatePlayerNameFromInput = function (input) {
  ...
  if (typeof window.updatePlayerName === 'function') {
    window.updatePlayerName(playerKey, newName);
  }
};
