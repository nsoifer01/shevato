...
function saveGame(event) {
  ...
  if (currentEditId) {
    ...
    if (gameIndex !== -1) {
      ...
      showToast(
        `Game updated: ${player1Name} ${player1Goals} - ${player2Goals} ${player2Name}`,
        'success',
      );
    }
  } else {
    ...
    showToast(
      `Game added: ${player1Name} ${player1Goals} - ${player2Goals} ${player2Name}`,
      'success',
    );
  }
...
function deleteGame(id) {
  ...
  createConfirmationModal({
    ...
    onConfirm: () => {
      ...
      showToast(
        `Game deleted: ${player1Name} ${game.player1Goals} - ${game.player2Goals} ${player2Name}`,
        'success',
      );
    },
    onCancel: () => {
...
function updatePlayerIconDisplays() {
  ...
  if (player1IconDisplay)
    player1IconDisplay.innerHTML = `<span class="team-logo">${playerIcons.player1}</span>`;
  if (player2IconDisplay)
    player2IconDisplay.innerHTML = `<span class="team-logo">${playerIcons.player2}</span>`;
