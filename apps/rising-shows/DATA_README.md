...
The workflow `.github/workflows/refresh-rising-shows.yml` runs every **Monday at
...
git diff --stat apps/rising-shows/data.json
git add apps/rising-shows/data.json
git commit -m "chore(rising-shows): manual data refresh"
```
