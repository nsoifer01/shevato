...
const marioKartGlobals = [
  ...
  'highestPlayerWithRaces', 'importData', 'initializeAutoBackup', 'isFinitePosition', 'isValidRaceId',
  'loadData', 'openSidebar', 'openSidebarIconPicker', 'openSidebarPlayerSettings',
  'persistRaces', 'playerCount', 'playerNames', 'players', 'presentModal', 'raceDateTimeValue',
